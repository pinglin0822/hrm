...
use App\Admin\Repositories\PayslipCommission;
use Dcat\Admin\Form;
use Dcat\Admin\Grid;
use Dcat\Admin\Show;
use Dcat\Admin\Controllers\AdminController;

class PayslipCommissionController extends AdminController
{
    /**
     * Make a grid builder.
     *
    ...
    {
        return Grid::make(new PayslipCommission(), function (Grid $grid) {
    ...
    {
        return Show::make($id, new PayslipCommission(), function (Show $show) {
            $show->field('id');
    ...
    {
        return Form::make(new PayslipCommission(), function (Form $form) {
            $form->display('id');
