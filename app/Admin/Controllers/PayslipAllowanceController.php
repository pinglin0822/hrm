...
use App\Admin\Repositories\PayslipAllowance;
use Dcat\Admin\Form;
use Dcat\Admin\Grid;
use Dcat\Admin\Show;
use Dcat\Admin\Controllers\AdminController;

class PayslipAllowanceController extends AdminController
{
    /**
     * Make a grid builder.
     *
    ...
    {
        return Grid::make(new PayslipAllowance(), function (Grid $grid) {
    ...
    {
        return Show::make($id, new PayslipAllowance(), function (Show $show) {
            $show->field('id');
    ...
    {
        return Form::make(new PayslipAllowance(), function (Form $form) {
            $form->display('id');
